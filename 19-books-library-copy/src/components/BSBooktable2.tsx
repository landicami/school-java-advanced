...
const BSBookTable2: React.FC<BSBookTableProps> = ({ books }) => {
	...
	const sortIcon = (key: SortKeys) => {
		return sortKey === key
			? sortAscending
				? <span role="img" aria-label="Ascending">A-Z</span>
				: <span role="img" aria-label="Descending">Z-A</span>
			: null
	...
	return (
		<Table bordered hover responsive striped>
			<thead>
				<tr>
					<th colSpan={3} className="display-5">Books</th>
					<th colSpan={2} className="display-5">Author</th>
				</tr>
				<tr>
